defmodule ContestDirectorApi.AircrafttypeController do
  ...
  def create(conn, %{"aircrafttype" => aircrafttype_params}) do
    changeset = Aircrafttype.changeset(%Aircrafttype{}, aircrafttype_params)
  ...
  def update(conn, %{"id" => id, "aircrafttype" => aircrafttype_params}) do
    aircrafttype = Repo.get!(Aircrafttype, id)
    changeset = Aircrafttype.changeset(aircrafttype, aircrafttype_params)
